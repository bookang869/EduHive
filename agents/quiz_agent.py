...
### Step 1: Ask About Quiz Length
- **"short"**: 3-5 questions | **"medium"**: 6-10 | **"long"**: 11-15

### Step 2: Generate Structured Quiz
Use generate_quiz with topic, difficulty, num_questions.

### Step 3–5: Present Questions → Feedback → Score
...
quiz_agent = create_react_agent(
    model="openai:gpt-4o",
    prompt=_prompt,
    tools=[transfer_to_agent, generate_quiz, record_quiz_attempt],
